    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                #define BLURPIXEL(weight, kernelx) \
                    SAMPLE_TEXTURE2D(_CameraOpaqueTexture, sampler_CameraOpaqueTexture, uv + float2(kernelx * _Size * _CameraOpaqueTexture_TexelSize.x, 0)) * weight
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                #define BLURPIXEL(weight, kernely) \
                    SAMPLE_TEXTURE2D(_CameraOpaqueTexture, sampler_CameraOpaqueTexture, uv + float2(0, kernely * _Size * _CameraOpaqueTexture_TexelSize.y)) * weight
